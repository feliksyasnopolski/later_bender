export type ApiErrorCode = "unauthorized" | "not_found" | "validation_failed" | "backend_unavailable" | "workspace_unavailable" | "capability_unavailable" | "workspace_not_found" | "workspace_not_ready" | "execution_not_found" | "execution_not_running" | "invalid_cursor" | "invalid_range" | "not_text" | "path_invalid" | "path_not_found" | "path_exists" | "path_not_file" | "source_required" | "source_conflict" | "unsupported_url_scheme" | "invalid_url" | "blocked_destination" | "redirect_blocked_destination" | "too_many_redirects" | "fetch_timeout" | "upstream_http_failure" | "file_too_large" | "empty_fetch";
