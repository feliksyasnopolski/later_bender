...
const fileSearchView = (value: any): any => ({ kind: "file", ref: value.ref, number: value.number, filename: value.filename, media_type: value.media_type, project: value.project, tags: value.tags, snippet: value.snippet, match: value.match, created_at: value.created_at, updated_at: value.updated_at });
